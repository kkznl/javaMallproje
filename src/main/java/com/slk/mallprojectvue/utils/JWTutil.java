package com.slk.mallprojectvue.utils;
...
public class JWTutil {
    ...
    private static String JWT_SECRTE = "slk520yl";
    ...
    public static String creatJWT(Map claims,String subject,long ttlMillis){
